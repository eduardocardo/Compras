 ...
 */
public class AdapterHorizontalFamilias extends RecyclerView.Adapter<AdapterHorizontalFamilias.ViewHolder> {
    ...
    public AdapterHorizontalFamilias(Familia[] familias) {
        ...
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (iOnItemClickListener != null) {
                    iOnItemClickListener.onItemClickListener(holder.view, position, familias[position]);
                }
            }
        });

        holder.nombre.setText(familias[position].getNombre());
        holder.precio.setVisibility(View.GONE);

        String urlImagen = familias[position].getUrlFoto();
